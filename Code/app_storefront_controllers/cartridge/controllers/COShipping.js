...
function handleShippingSettings(cart) {
    Transaction.wrap(function () {
        ...
        //adds to cart shipping object
        shippingAddress.custom.testArea = session.forms.singleshipping.shippingAddress.addressFields.area.value;
...
function singleShipping() {
    ...
    singleShippingForm.handleAction({
        save: function () {
            ...
            var a = session.forms.singleshipping.shippingAddress;
            var c = session.forms.singleshipping.shippingAddress.addToAddressBook.value;
            var b = customer.authenticated;
